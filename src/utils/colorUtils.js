...
export const CATEGORY_COLORS = {
  '烧烤': [236, 72, 153],         // #ec4899 (粉红)
  '火锅': [249, 115, 22],         // #f97316 (橙色)
  '酒吧': [139, 92, 246],         // #8b5cf6 (紫色)
  '咖啡馆': [251, 191, 36],       // #fbbf24 (黄色)
  '夜市': [34, 211, 238],         // #22d3ee (青蓝)
  '特色餐饮': [16, 185, 129],     // #10b981 (绿色)
  '中餐厅': [20, 184, 166],       // #14b8a6 (青绿色)
  '广东菜(粤菜)': [6, 182, 212]   // #06b6d4 (青色)
}
...
export function getCategoryColor(category) {
  ...
  // 生成 HSL 颜色，使用高饱和度和中等亮度
  const h = Math.abs(hash % 360) // 色相 0-360
  const s = 70 + (Math.abs(hash >> 8) % 20) // 饱和度 70-90%
  const l = 50 + (Math.abs(hash >> 16) % 15) // 亮度 50-65%
